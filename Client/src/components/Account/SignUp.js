        ...
        <div class="content">
          <form onSubmit={handleSubmit(submit)}>
            ...
            <div class="role-details">
              <input type="radio" name="role" id="dot-3" value={"643e5eafafc4abef0ed761ed"}  {...register("role")} />
              <input type="radio" name="role" id="dot-4" value={"643e5ea1afc4abef0ed761eb"}  {...register("role")} />
